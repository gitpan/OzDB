# This Makefile is for the OzDB extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/OzDB.pm]
#     AUTHOR => q[Daniel Remsburg, aka Osbourne <nexen@linuxops.net>]
#     NAME => q[OzDB]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/OzDB.pm]
...
TO_INST_PM = lib/OzDB.html \
	lib/OzDB.html.bug0 \
	lib/OzDB.pm \
	lib/pod2htmd.tmp \
	lib/pod2htmi.tmp

PM_TO_BLIB = lib/OzDB.html.bug0 \
	blib/lib/OzDB.html.bug0 \
	lib/OzDB.html \
	blib/lib/OzDB.html \
	lib/pod2htmi.tmp \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW)\
	  lib/OzDB.pm $(INST_MAN3DIR)/OzDB.$(MAN3EXT) 
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  blib/lib/OzDB.html blib/lib/pod2htmi.tmp blib/lib/OzDB.html.bug0 $(MAKEFILE_OLD) $(FIRST_MAKEFILE) blib/lib/pod2htmd.tmp blib/lib/OzDB.pm
...
metafile :
	...
	$(NOECHO) $(ECHO) 'name:         OzDB' >> META.yml
	$(NOECHO) $(ECHO) 'version:      0.1.3' >> META.yml
	$(NOECHO) $(ECHO) 'version_from: lib/OzDB.pm' >> META.yml
...
ppd:
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="$(DISTNAME)" VERSION="0,1,3,0">' > $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <TITLE>$(DISTNAME)</TITLE>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <ABSTRACT>database interface module for OzBot</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Daniel Remsburg, aka Osbourne &lt;nexen@linuxops.net&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')'\
	  lib/OzDB.html.bug0 blib/lib/OzDB.html.bug0 \
	  lib/OzDB.html blib/lib/OzDB.html \
	  lib/pod2htmi.tmp blib/lib/pod2htmi.tmp \
	  lib/OzDB.pm blib/lib/OzDB.pm \
